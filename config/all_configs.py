def predict_prompt_llama_config(this_config):
    this_config.out_dir = 'opt_out'
    this_config.compile = True
    this_config.wandb_log = True
    this_config.wandb_project = 'predict'
    this_config.wandb_run_name='1st_1seg_m20_opt'
    ...
    this_config.pretrained_model_name = 'facebook/opt-2.7b'
    this_config.accelerate = True
    # this_config.load_name = 'predict_1st_kl_1seg_m20_llama.pt'
    this_config.ckpt_name = 'predict_1st_1seg_m20_opt.pt'

    this_config.dataset = 'autocompressor'

    this_config.batch_size = 3
    this_config.block_size = 512
    this_config.min_block_size = 256
    this_config.gradient_accumulation_steps = 8
